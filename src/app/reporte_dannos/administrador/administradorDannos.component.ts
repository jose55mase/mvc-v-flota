...
@Component({
  selector: 'administrador-Dannos',
  templateUrl: './administradorDannos.component.html',
  styleUrls: ['./administradorDannos.component.css'],
  providers: [DannosService]
})
export class AdministradorDannosComponent implements OnInit {
  ...
  public verDanno(danno : Dannos){       
    ...
    this.ver.open(ModalDannosAdministrador, { }) 
  };
}
...
@Component({  
  templateUrl: './modalDannoAdministrador.html',  
  providers: [ DannosService ]
})
export class ModalDannosAdministrador implements OnInit{
  danno: Dannos;
  private dannos: Dannos[];
  ngOnInit(){  };
